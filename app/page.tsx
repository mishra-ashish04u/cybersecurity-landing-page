  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50/50 to-amber-50">
            ...
            <CardContent className="p-8 md:p-12">
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">A small note from Sanjay:</h3>
                </div>

                <p className="text-lg text-slate-700 leading-relaxed">
                  I've mentored hundreds of cybersecurity learners — and I realised most people don't struggle with
                  motivation… they struggle with <span className="font-semibold text-slate-900">clarity</span>.
                </p>
      ...
      <footer className="container mx-auto px-4 py-12 text-center">
        <Badge variant="outline" className="border-[#ffda6a] text-slate-600 px-4 py-2 text-sm">
          <Heart className="w-4 h-4 mr-2 inline text-red-500 fill-red-500" />
